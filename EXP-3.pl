...
% Indirect flight (one or more transfers)
...
deptime([P1-_P2:_Fnum:Dep|], Dep).

% transfer requires at least 40 minutes between arrival and next departure
transfer(H1:M1, H2:M2) :-
    60*(H2 - H1) + M2 - M1 >= 40.

% A FLIGHT DATABASE (cleaned up)
...
timetable(ljubljana, london, [
    11:10 / 12:20 / ju200 / [fr],
    11:25 / 12:20 / ju212 / [su]
]).
...
cd('C:/Users/<your name>/OneDrive/Documents/Prolog').

[flights].

flight(london, zurich, mo, Fnum, Dep, Arr).